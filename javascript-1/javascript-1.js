...
*/
  ...
  let phone1 = new Phone('iphone', '8', 64, 'red', false)
  
  let phone2 = new Phone('samsung', 'S8', 50, 'blue', false)
  
  let phone3 = new Phone('Nokia', 'Brick', 10, 'grey', false)
